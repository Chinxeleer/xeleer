                                        ...
                                        Ok(posts) => {
                                            ...
                                            if let Some(post) = post {
                                                view! {
                                                    ...
                                                    />
                                                    <article
                                                        class="prose prose-sm md:prose-lg rose-pre:bg-gray-900 text-wrap prose-pre:p-2 prose-pre:m-0 md:prose-code:p-2 prose-p:m-1 prose-p:text-pink-50 prose-strong:text-purple-200 prose-code:text-orange-200 prose-code:bg-gray-900 prose-p:text-sm prose-headings:text-purple-200 prose-slate prose-a:text-purple-200 underline-offset-2 decoration-2 text-justify prose-h1:text-center prose-h2:text-2xl prose-h1:text-3xl pb-20 "
